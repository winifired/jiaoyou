					...
					<view class="t-message-item">
						...
						<view v-if="item.type !== 'TIMGroupTipElem'"
							...
							<view>
								...
								<TUI-LocationMessage v-if="item.type === 'TIMLocationElem'" :message="item"
									:isMine="item.flow==='out'"></TUI-LocationMessage>
							</view>
							<image class="t-message-avatar" v-if="item.flow==='out'" mode="aspectFill"
								:src="item.avatar || 'https://sdk-web-1252463788.cos.ap-hongkong.myqcloud.com/component/TUIKit/assets/avatar_21.png'">
							</image>
						</view>
					</view>
...
<script>
	...
	import TUILocationMessage from "../message-elements/location-message/index.vue";
	export default {
		data() {
			return {
				avatar: '',
