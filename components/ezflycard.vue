	...
	<view style="position: relative;height: 100%;width:100%;" :style="{paddingLeft:paddingLeft+'rpx'}">
		<view style="position: absolute;left:50%;top:50%;transform: translate(-50%,-50%);"
			...
			<view class="card" style="z-index: 13;"
				:style="{width:cardWidth+'rpx',height:cardHeight+'rpx',left:left+'px',top:top+'px','border-radius':borderRadius+'rpx',backgroundColor:cardBgColor}"
			...
			<view class="card" style="z-index: 12;"
				:style="{width:width2+'rpx',height:height2+'rpx',left:left2+'px',top:top2+'px','border-radius':borderRadius+'rpx',backgroundColor:cardBgColor}"
				:class="{'animation':isAnimating,'shadowEffect':hasShadow,'boderEffect':hasBorder}">
				<slot name="secondCard"></slot>
			</view>
			<view class="card" style="z-index: 11;"
				:style="{width:width3+'rpx',height:height3+'rpx',left:left3+'px',top:top3+'px','border-radius':borderRadius+'rpx',backgroundColor:cardBgColor}"
				:class="{'animation':isAnimating,'shadowEffect':hasShadow,'boderEffect':hasBorder}">
				<slot name="thirdCard"></slot>
			</view>
			<view class="card" style="z-index: 10;"
				:style="{width:width4+'rpx',height:height4+'rpx',left:left4+'px',top:top4+'px','border-radius':borderRadius+'rpx',backgroundColor:cardBgColor,opacity:opacity4}"
				:class="{'animation':isAnimating,'shadowEffect':hasShadow,'boderEffect':hasBorder}">
			</view>
		</view>
	</view>
