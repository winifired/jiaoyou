<template>
	<view class="slider-range" :class="{ disabled: disabled }"
		...
		<view class="slider-range-inner" :style="{ height: height + 'px' }">
          ...
          height: blockSize + 'px',
          left: lowerHandlePosition + '%',
        }" @touchstart.stop="_onTouchStart" @touchmove.stop="_onBlockTouchMove" @touchend.stop="_onBlockTouchEnd"
...
<style scoped>
	...
	.slider-handle-block {
		...
		background: linear-gradient(115deg, #FE0B87, #FC4746) !important;
		box-shadow: 0px 3rpx 21rpx 0px rgba(254, 65, 103, 0.52);
		position: absolute;
		top: 50%;
